(ns yugabyte.ysql.causal-reverse
...
(def table-name "causal_reverse")

(defrecord YSQLCausalReverseYbClient []
  c/YSQLYbClient
...
(c/defclient YSQLCausalReverseClient YSQLCausalReverseYbClient)
